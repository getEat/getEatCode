...
<body>
		...
		<div class="login">
			...
			<div class="sap_tabs">	
					...
					<div class="review-top">
                                            <input type="text" value="<%=res.getString("nama")%>" id="Nama" style="width:500px ;" readonly>
						<br>
						<br>
						<input type="text" value="<%=res.getString("SocialMedia")%>" id="Alamat" style="width:500px" readonly>
						<br>
						<br>
						<input type="text" value="<%=res.getString("email")%>" id="Email" style="width:500px" readonly>
						<br>
						<br>
						<input type="text" value="<%=res.getString("password")%>" id="Password" style="width:500px">
						<br>
	...
	<div class="footer">
		<p>&copy; © 2016 GetEat!. All Rights Reserved</p>
	</div>
</body>
</html>