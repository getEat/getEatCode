...
<html>
<head>
<title>GetEat! | Home FoodHunter</title>
			    ...
			    <div class="web-forms">
				 ...
				 <div class="col-md-8 first-one">
				  ...
				  <div class="first-one-inner">
                                      <h3>Post A Review</h3>
                                      <form action="ServletReview" method="post">
                                      <input type="text" placeholder="Name Tenant" id="Name" style="width:550px; height: 50px" name="nama">
						<br>
						<input type="text" placeholder="Owner" id="owner" style="width:550px; height: 50px" name="owner">
						<br>
                                                <input type="text" placeholder="Adress" id="Adress" style="width:550px; height: 50px" name="adress">
						<br>
                                                <textarea rows="10" placeholder="Review" id="Review" style="width:550px; height: 250px" name="review"></textarea>
						<br>
