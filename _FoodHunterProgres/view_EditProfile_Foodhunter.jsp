		...
		<div class="login">
			...
			<div class="sap_tabs">	
					...
					<div class="review-top">
						...
						<br>
						<br>
						<input type="text" placeholder="Username" id="Username" style="width:500px">
						<br>
						<br>
						<input type="text" placeholder="Password" id="Password" style="width:500px">
						<br>
						<br>
                                               <%request.setAttribute("now", s.getAttribute("email"));%>
<center>
